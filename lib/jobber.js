...
// Jobber API version - using a known stable version
// Try 2025-01-20 first, fallback to 2023-08-18 if needed
...
export async function exchangeCodeForTokens(code) {
  ...
  console.log('📊 Scopes granted:', tokens.scope || '⚠️  NONE - App needs scopes configured in Jobber Developer Center');
...
export async function getJobberAccountInfo(accessToken) {
  ...
  const response = await fetch('https://api.getjobber.com/api/graphql', {
    ...
    headers: {
      ...
      'X-JOBBER-GRAPHQL-VERSION': JOBBER_API_VERSION  // ✅ Add API version header
    },
