...
//
// Copy for the /affordable-small-business-website-design landing page.
//
...
export const ninetyNineData = {
  meta: {
    // Targets "affordable/cheap small business website design" (KD 0-6, real
    // volume). "$99 website" and "99 dollar websites" have zero US volume, so
    // the price stays the hook in the copy but never carries the ranking.
    title: 'Affordable Small Business Website Design | $99/mo, No Setup Fee',
    description:
      'Affordable small business website design for $99 a month — no setup fee, no contract, live in about a week. Built to get you found and get you called.',
    canonical: 'https://visionaryadvance.com/affordable-small-business-website-design',
  },

  hero: {
    badge: 'Affordable small business websites',
    ...
    primaryCtaHref: '/contact?from=affordable-small-business-website-design',
  ...
  pricing: {
    heading: 'Affordable small business website design, one flat price',
    price: '$99',
    period: '/ month',
    ...
    ctaHref: '/contact?from=affordable-small-business-website-design',
    upsellNote: 'Need more pages, a blog, or ongoing SEO work?',
    upsellLinkLabel: "Let's talk about that",
    upsellLinkHref: '/contact?from=affordable-small-business-website-design',
  },
