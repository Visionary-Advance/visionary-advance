...
/**
 * Track a website audit being run via the audit tool
 * @param {string} auditedUrl - The URL the visitor submitted for auditing
 */
export function trackAuditSubmit(auditedUrl) {
...
/**
 * Track a visitor requesting their audit report by email (key conversion)
 * @param {string} auditedUrl - The URL that was audited
 */
export function trackAuditEmailSubmit(auditedUrl) {
  trackEvent('audit_email_submit', {
    audited_url: auditedUrl,
  })
}
