          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="background: linear-gradient(135deg, #008070 0%, #005F52 100%); padding: 25px; border-radius: 8px; text-align: center; margin-top: 30px; color: white;">
                ...
                <p style="font-size: 16px; margin: 15px 0;">We specializes in optimizing websites for maximum performance and lead generation.</p>
                <a href="https://visionaryadvance.com/contact" class="cta" style="background: white; color: #008070;">Get Expert Help</a>
              </div>
            </div>

            <div class="footer">
              <p style="margin: 0;">This audit was generated by <strong>Visionary Advance</strong></p>
              <p style="margin: 10px 0 0 0;">Professional website design and development</p>
