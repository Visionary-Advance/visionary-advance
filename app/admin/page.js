  ...
  const tools = [
    {
      ...
      stats: ['Leads', 'Pipeline', 'Activities']
    },
    {
      name: 'SEO',
      description: 'Track search rankings, analytics, and site performance',
      href: '/admin/seo',
      icon: SEOIcon,
      color: 'from-teal-500 to-cyan-500',
      stats: ['Sites', 'Rankings', 'Reports']
    },
    {
      name: 'DevOps',
    ...
    {
      name: 'Finance',
      description: 'Track income, expenses, and quarterly tax estimates',
      href: '/admin/finance',
      icon: FinanceIcon,
      color: 'from-emerald-500 to-green-500',
      stats: ['Income', 'Expenses', 'Tax Estimator']
    }
  ]
