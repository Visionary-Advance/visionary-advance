...
export default function CRMLayout({ children }) {
  ...
  const navItems = [
    ...
    { href: '/admin/crm/leads', label: 'Leads', icon: LeadsIcon },
    { href: '/admin/crm/clients', label: 'Clients', icon: ClientsIcon },
    { href: '/admin/crm/businesses', label: 'Businesses', icon: BuildingIcon },
    { href: '/admin/crm/pipeline', label: 'Pipeline', icon: KanbanIcon },
    { href: '/admin/crm/projects', label: 'Projects', icon: ProjectsIcon },
    { href: '/admin/crm/pocket', label: 'Recordings', icon: MicIcon },
  ]
