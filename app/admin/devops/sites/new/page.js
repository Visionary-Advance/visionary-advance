...
import HealthAPITemplate from '@/Components/Admin/DevOps/HealthAPITemplate'
...
export default function NewSitePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/devops/sites', {
        method: 'POST',
      ...
      router.push(`/admin/devops/sites/${data.site.id}`)
    } catch (err) {
    ...
    <div className="max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-400">Configure a new site for monitoring</p>
        </div>
      </div>
