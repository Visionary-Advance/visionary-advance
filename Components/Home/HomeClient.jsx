...
export default function HomeClient({ title, titleVariant }) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && window.gtag && titleVariant) {
      window.gtag('event', 'ab_view', {
        experiment_id: 'home_title',
